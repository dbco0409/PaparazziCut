...
<option name="community">커뮤니티</option>
<option name="event">이벤트</option>
<option name="mypage">마이페이지</option>
<option name="companypage">기업회원전용</option>
<option name="adminpage">관리자전용</option>
</select>
</li>
</ul>
<ul>
...
<ul>
<li>서브메뉴 이미지</li>
<li><input type="file" name="subimg" /></li>
</ul>
<ul>
<li>목록보기 권한</li>
<li>
